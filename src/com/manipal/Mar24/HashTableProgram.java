...
public class HashTableProgram {
	...
	Map mylist = new Hashtable();
	Scanner sc = new Scanner(System.in);
	public static void main(String[] args) {
		// TODO Auto-generated method stub	
		
		HashTableProgram obj = new HashTableProgram(); 
		 ...
		 void addmethod()
		{
		 ...
		 void sizemethod()
		 {
			 System.out.println("\nCurrent size of the HashTable is : "+mylist.size());
		 }
		
		 void traversemethod()
		 {
			 System.out.println("\nDisplaying keys of HashTable : "+mylist.keySet());
			 			 
			 System.out.println("\nDisplaying values of HashTable : "+mylist.values());
